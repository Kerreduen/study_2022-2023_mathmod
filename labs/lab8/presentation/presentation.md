...
![График линейный для случая 1](image/figure_1.png){#fig:001 width=60% height=60%}

![График параметрический для случая 1](image/figure_1(parametric).png){#fig:002 width=60% height=60%}

## Втором случае

![График линейный для случая 2](image/figure_2.png){#fig:003 width=60% height=60%}

![График параметрический для случая 2](image/figure_2(parametric).png){#fig:004 width=60% height=60%}
